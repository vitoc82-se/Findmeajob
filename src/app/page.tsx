    ...
    return (
      <main className="mx-auto max-w-2xl px-6 py-16 text-center">
        ...
        <h1 className="mt-6 text-3xl font-semibold tracking-tight">
          Let&apos;s find you a <span className="text-indigo-600">better job.</span>
        </h1>
        <p className="mx-auto mt-3 max-w-md text-neutral-600">
          Give us your CV once. We read it, search real job sources for you, and rank the
          roles that actually fit — with a note on why. No endless scrolling.
        </p>
        <button
          onClick={() => setStep("cv")}
          className="mt-8 rounded-md bg-indigo-600 px-6 py-2.5 text-sm font-medium text-white hover:bg-indigo-700"
        >
          Get started
        </button>
        <p className="mt-4 text-xs text-neutral-400">Takes about a minute.</p>
      </main>
    );
  }
